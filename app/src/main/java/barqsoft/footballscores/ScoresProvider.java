...
public class ScoresProvider extends ContentProvider
{
    ...
    static UriMatcher buildUriMatcher() {
        ...
        matcher.addURI(authority, ScoresContract.LEAGUE, MATCHES_WITH_LEAGUE);
        matcher.addURI(authority, ScoresContract.ID, MATCHES_WITH_ID);
        matcher.addURI(authority, ScoresContract.DATE, MATCHES_WITH_DATE);
        return matcher;
    }
